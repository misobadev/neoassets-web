						...
						<div className="flex items-start justify-between gap-3">
							<div className="min-w-0">
								<div className="flex items-center gap-2 flex-wrap">
									...
									{subRegion ? <span className="badge badge-solid-secondary badge-sm shrink-0"><RegionLabel region={subRegion} /></span> : null}
										...
										return (
											<div key={f.id} className="space-y-2">
												<p className="font-medium text-sm flex items-center gap-2">
													...
													{f.region ? <span className="badge badge-solid-secondary badge-xs"><RegionLabel region={f.region} /></span> : null}
												</p>
